...
export const BestLifeTemplate = ({ medicines, patientName, doctorName, specialization, consultDate, birthday, sex, prcNo, ptrNo }) => (
  <Page size="A4" style={styles.page}>
    ...
    <View style={styles.logoHeader}>
      ...
      <Image
        style={styles.logoImg}
        src="https://cv-rx-gen-website.vercel.app/Group%201.png"
      />
    </View>
